...
if Rails.env.development?
    ...
    user1 = Person.create!(name: 'Rocky Williams', email: 'rockyrd@example.com', password: 'password', home_phone: '(641) 895-5555', dob:'1990-01-25', bio: 'We own two dogs at home!', city: 'Grinnell', state: 'IA')
    ...
    user2 = Person.create!(name: 'Matilda Simmion', email: 'msims@example.com', password: 'password', home_phone: '(641) 894-3365', dob:'1990-07-10', bio: 'I have volunteered at PALS for 10 years now--it is a wonderful place to volunteer at.', city: 'Grinnell', state: 'IA')
    ...
    (user2.acting_as).donations.create!(amount: 50.00, date: '2018-04-25')
    
    Person.create!(name: 'Virginia Potts', password: 'babydonthurtme', email: 'whatislove@babydonthurtme.com', home_phone: '(888) 888-8888', dob: '1976-03-14', city: 'Grinnell', state: 'IA')
    
    Person.create!(name: 'Jane Foster', password: 'science!', email: 'fostersaucester@science.com', home_phone: '(123) 456-7890', dob: '1989-04-16', city: 'Grinnell', state: 'IA')
    
    Person.create!(name: 'Marina Diamondis', password: 'iamnotarobot', email: 'diamondis@marinara.com', home_phone: '(641) 123-4567', dob: '1992-06-30', city: 'Grinnell', state: 'IA')
