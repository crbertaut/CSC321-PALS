...
if Rails.env.development?
    ...
    User.create!(name: 'Admin', home_email: 'admin@example.com', username: "admin", password: 'password')

    user1 = User.create!(name: 'Rocky Williams', home_email: 'rockyrd@example.com', password: 'password', home_phone: '(641) 895-5555', dob:'1990-01-25', username: 'RockyRoad', bio: 'We own two dogs at home!')
    user1.interests << (Interest.find_by name: 'Dog shifts')
    
    user2 = User.create!(name: 'Matilda Simmion', home_email: 'msims@example.com', password: 'password', home_phone: '(641) 894-3365', dob:'1990-07-10', username: 'Sims', bio: 'I have volunteered at PALS for 10 years now--it is a wonderful place to volunteer at.')
    ...
    User.create!(name: 'Virginia Potts', username: 'whatislove', password: 'babydonthurtme', home_email: 'whatislove@babydonthurtme.com', home_phone: '', dob: '1976-03-14')
    User.create!(name: 'Jane Foster', username: 'fostersauce', password: 'science!', home_email: 'fostersaucester@science.com', home_phone: '(123) 456-7890', dob: '1989-04-16')
    User.create!(name: 'Marina Diamondis', username: 'marinara', password: 'iamnotarobot', home_email: 'diamondis@marinara.com', home_phone: '', dob: '1992-06-30')
